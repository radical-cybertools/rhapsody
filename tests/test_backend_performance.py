...
This module tests the performance characteristics of backends under various load conditions that
AsyncFlow workflows might experience.
"""
...
class TestBackendPerformance:
    ...
    async def test_backend_parallel_operations(self):
        ...
        try:
            ...
            results = await asyncio.gather(*[submit_and_wait(i, 10) for i in range(5)])
    ...
    async def test_backend_resource_scaling(self):
        ...
        for workers in worker_counts:
            ...
            try:
                ...
                print(
                    f"Workers: {workers}, Completed: {len(completed)}/{num_tasks}, Time: {execution_time:.2f}s"
                )
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        try:
            ...
            print(
                f"✅ Performance test passed! Completed {len(completed)}/10 tasks in {elapsed:.2f}s"
            )
