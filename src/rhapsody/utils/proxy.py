...
# time to keep the bridge alive
_TIMEOUT = 300
# ms to linger after close
_LINGER_TIMEOUT = 250
# number of messages to buffer before dropping (default is 0 -> infinite)
_HIGH_WATER_MARK = 0
...
#
# The bridge listens on a `REP` socket (`bridge_request`) for incoming client
# or agent connections, identified by a common session ID.  A client connection
